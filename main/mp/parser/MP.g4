...
stmt:   assignState | ifState | forState
            ...
            | returnState | callState | cpstate | withState;
...
expr1: expr2 (EQUAL|NOTEQUAL| LESSTHAN|LESOREQUAL|GREOREQUAL|GREATERTHAN ) expr2 | expr2;
...
expr5: expr6 LSB expr RSB
    | expr6;
expr6: LB expr RB
     | INTLIT | FLOATLIT | STRINGLIT | BOOLEANLIT | ID | ID LB exprList RB; //funcall;
...
fragment  Andthen: 'and then';
fragment  Orelse: 'or else';
ANDTHEN : Andthen;
ORELSE  : Orelse;
//operator
